...
namespace IPO.Dictionary.UnitTests.Services.Processors
{
    ...
    {
        private readonly DocxProcessor _processor;

        public DocxProcessorTests()
        {
            this._processor = new DocxProcessor();
        }
        ...
        public void SearchDocumentWhenFileEncryptedReturnsFileEncryptedError()
        {
            ...
            var processModel = new DictionarySearchProcessModel(DictionarySearchFileType.Docx, DocumentBuilder.CreateDocxWithEncryption(), Array.Empty<DictionaryValue>());
        ...
        public void SearchDocumentWhenFileCannotBeLoadedReturnsFileCannotBeLoadedError()
        {
            ...
            var processModel = new DictionarySearchProcessModel(DictionarySearchFileType.Docx, null!, Array.Empty<DictionaryValue>());
        ...
        public void SearchDocumentWhenFileContainsMatchReturnsCorrectMatch()
        {
            ...
            var processModel = new DictionarySearchProcessModel(DictionarySearchFileType.Docx, DocumentBuilder.CreateDocx(match: match), dictionaryData);
        ...
        {
            // Arrange
            var expectedType = DictionarySearchFileType.Docx;
